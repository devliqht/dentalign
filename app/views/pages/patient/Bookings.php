<div class="pb-8">
    ...
    <div id="upcoming-section" class="appointment-section">
     ...
     strtotime($appointment["DateTime"])
                            ...
                            <span class="bg-green-100/60 text-green-800 px-2 py-1 rounded-full text-xs">Upcoming</span>
                        </div>
    ...
    <div id="completed-section" class="appointment-section">
     ...
     strtotime($appointment["DateTime"])
                            ...
                            <span class="bg-gray-100/60 text-gray-800 px-2 py-1 rounded-full text-xs">Completed</span>
                        </div>
                        <h4 class="font-semibold text-gray-900 mb-1">
                            Dr. <?php echo htmlspecialchars(
                                $appointment["DoctorFirstName"] .
...
class="bg-nhd-blue/80 text-white px-2 py-1 text-xs hover:bg-nhd-blue transition-colors rounded-2xl">
    ...
    "id"
                                ...
                                <td class="py-2 px-3">
                                    <span class="bg-gray-100/60 text-gray-800 px-2 py-1 rounded-full text-xs font-medium">
                                        Completed
                                    </span>
                                </td>
                                <td class="py-2 px-3">
