    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-4">
            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div class="text-gray-900"><?php echo htmlspecialchars($_SESSION['user_name']); ?></div>
            </div>
            
            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                <div class="font-medium text-gray-700">Email:</div>
                <div class="text-gray-900"><?php echo htmlspecialchars($_SESSION['user_email']); ?></div>
            </div>
            
            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                <div class="font-medium text-gray-700">Account Type:</div>
                <div>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo $_SESSION['user_type'] === 'Patient' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'; ?>">
            ...
            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div class="text-gray-900"><?php echo htmlspecialchars($_SESSION['user_id']); ?></div>
            </div>
        </div>
