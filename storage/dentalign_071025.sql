...
--
-- Host: localhost
-- Generation Time: Jul 09, 2025 at 07:14 PM
...
(31, 1, 3, '2025-07-11 08:00:00', 'Consultation', 'bsaofbaoifhaifia', '2025-07-09 03:02:36', 'Pending Cancellation'),
...
(36, 1, '4', 'Healthy', ''),
(37, 1, '5', 'Healthy', ''),
(38, 1, '6', 'Healthy', 'Root Canal. Extraction. Crown. Filling. Cavity. Crown. Root Canal'),
(39, 1, '7', 'Healthy', 'Cavity. Filling. Crown'),
(40, 1, '8', 'Healthy', ''),
(41, 1, '9', 'Healthy', ''),
(42, 1, '10', 'Healthy', ''),
(43, 1, '11', 'Healthy', ''),
...
(7, 25, 1, 'Pending', 4, '2025-07-09 13:20:30', NULL);
...
(1, 1, '1', 'D1208', 'Topical application of fluoride', 25555.00, '2025-07-11', '2025-07-10 00:30:14', NULL),
...
--
ALTER TABLE `AppointmentReport`
  MODIFY `AppointmentReportID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `dentalchartitem`
--
ALTER TABLE `dentalchartitem`
  MODIFY `DentalChartItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT for table `dentalcharts`
--
ALTER TABLE `dentalcharts`
  MODIFY `DentalChartID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `TreatmentPlan`
  MODIFY `TreatmentPlanID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `TreatmentPlanItem`
--
ALTER TABLE `TreatmentPlanItem`
  MODIFY `TreatmentItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
